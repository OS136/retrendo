...
(6, 'Mango', 'Kjol', 'Blå', '179', 'S', 'Mango', 'Bra', '/images/kjol.png', 'Bra, varan har synliga men mindre tecken på användning. Inga stora defekter.', 'kjol-mango', 'Dam'),
(7, 'Apple', 'Iphone 12', 'Svart', '5499', '128 GB', 'Apple', 'Bra', '/images/apple_iphone12.png', 'Bra, varan har synliga men mindre tecken på användning. Inga stora defekter.', 'iphone12-apple', 'Elektronik'),
(8, 'Samsung', 'TV', 'Svart', '4999', '55 tum', 'Samsung', 'Bra', '/images/samsung.png', 'Bra, varan har synliga men mindre tecken på användning. Inga stora defekter.', 'smarttv-samsung', 'Elektronik');