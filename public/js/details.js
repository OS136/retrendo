...
fetch(`/product/${slug}/similar`)
  ...
  .then(similarProducts => {
    const similarContainer = document.querySelector(".similarContainer");
      ...
      //const productquantity = Math.min(4, similarProducts.length);
        //for (let i = 0; i < productquantity; i++) {
            //const products = similarProducts[i];
...
buttonAdd.addEventListener("click", function() {
    ...
    // Gå till kassan knappen
 const buttonCheckout = document.querySelector('checkOut', function(event){
